...
# parser.add_argument("--model_name_or_path", default='D:\\project\\nlp\\pretrained_model\\hfl\\chinese-bert-wwm-ext')
# parser.add_argument("--dataset_name")
parser.add_argument("--model_name_or_path", default='../plm/chinese-roberta-wwm-ext')
parser.add_argument("--dataset_name",default="chinese_dialogue_8s")
